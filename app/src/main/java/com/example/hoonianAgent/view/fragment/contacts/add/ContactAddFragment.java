...
public class ContactAddFragment extends BaseFragmentFromMore implements ContactAddView {
    public static final int FRAGMENT_ID = 21;
    @Bean
    protected ContactAddImpl impl;
    @ViewById
    ...
    @Click(R.id.saveBtn)
    protected void addContact() {impl.save();}
}
